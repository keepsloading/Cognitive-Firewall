/**
 * NudgementExtractor
 * Content extraction pipeline — supports 4 fallback strategies:
 * 1. Targeted surface-specific selectors
 * 2. Mozilla Readability
 * 3. Adaptive ranked DOM candidates
 * 4. Clean body fallback
 *
 * Preserved from original hackathon build (Boundier/IIT Bombay).
 * Only the module export name has changed.
 */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    module.exports = factory();
  } else {
    root.NudgementExtractor = factory();
  }
